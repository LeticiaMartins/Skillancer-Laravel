...
@section('content')
    ...
    <div class="container">
      <div class="projeto-exibir">
        <a href= "/projetos_freela/editar/{{ $projeto->id_projeto }}" class="btn btn-default">Editar</a>
        <a href= "/projetos_freela/deletar/{{ $projeto->id_projeto }}" class="btn btn-default">Deletar</a>
